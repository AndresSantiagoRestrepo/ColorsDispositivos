...
class MainActivity2 : AppCompatActivity() {
    ...
    fun showScore() {
        ...
        val proposedColor = colorsGame!!.proposedBackColors
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        colorsGame!!.setOnChangeTargetColorListener(OnChangeTargetColorListener { newBackColor: Int, newTextColor: Int ->
